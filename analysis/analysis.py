...
if __name__ == "__main__":
    ...
    sub_DIR = DIR / "analysis" / "data" / "pilot"
    ...
    # Do cluster-based permutation analysis to look for statistical significant
    # differences between conditions.
    # get difference response between two conditions.
    evoked_diff = mne.combine_evoked(
        [evokeds_avrgd["distance/20"], evokeds_avrgd["distance/2000"]], weights=[1, -1])
