...
# concatenate raw files for n_blocks © Freidrich
...
for block in range(n_blocks):
    raw = mne.io.read_raw_brainvision(folder_path + file_name + str(block+1) + '.vhdr', preload=True)
...
fs = raw.info['sfreq'] # get sampling frequency